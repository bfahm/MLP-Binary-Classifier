...
def drop_features(train_x, test_x, needed):
    # Needed refers to a the number of random features to be generated. In practice, the generated features
    # are much less due to duplicates in random choosing, but it helped in choosing the features roughly.
